                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        while (result[index].restaurant) {
                            ...
                            $("div." + result[index].restaurantID + " .collection-item ." + index).append($("<span>").addClass("title").text("Review posted on - " + result[index].date));
...
function submitReview(dataID) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $("div." + dataID + " .collection-item ." + index).append($("<span>").addClass("title").text("Review posted on - " + tempDate));
